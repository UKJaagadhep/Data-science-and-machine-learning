...
class poseDetector():
    ...
    def findAngle(self, img, landmark1_no, landmark2_no, landmark3_no, draw=True):
        # Get the landmarks
        x1, y1 = self.landmark_list[landmark1_no][1:]
        x2, y2 = self.landmark_list[landmark2_no][1:]
        x3, y3 = self.landmark_list[landmark3_no][1:]
        # Calculate the Angle
        ...
        if draw:
            ...
            cv2.putText(img, str(int(angle)), (x2, y2 + 50),
